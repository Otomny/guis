...
public interface Ordering {
	...
	static void processOrderingUnknown(Class<?> type, List<Object> list) {
		processOrdering(Utils.ensureClass(type, Ordering.class), list);
	}
	...
	static void processOrdering(Class<? extends Ordering> ordering, List<Object> list,
			Class<? extends Stringifier> stringifier) {
